...
import { Zap, Shield, Clock, Users, Volume2, Settings } from 'lucide-react';
...
const features = [
  ...
  },
  {
    icon: Zap,
    title: 'Sofort bereit',
    desc: 'Slash-Commands. Kein Prefix nötig. /play und los.',
    color: '#FFB800',
  },
  {
    icon: Volume2,
  ...
  },
  {
    ...
    desc: 'Eigene Stationen hinzufügen, Quality Presets, Fallback-Stationen.',
    color: '#FF2A2A',
  },
];
