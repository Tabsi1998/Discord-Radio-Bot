...
import { ExternalLink, Copy, Check, Wifi } from 'lucide-react';
...
function BotCard({ bot, index }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
        ...
        >
          {bot.avatar_url ? (
            ...
            <Wifi size={22} color={colors.accent} />
          )}
        </div>
        <div>
          <h3
      ...
      >
        {bot.description || 'Ein dedizierter Radio-Bot für deinen Server.'}
      </p>
    ...
    >
      <div className="section-container">
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <h2
            data-testid="bot-directory-title"
            style={{
              fontFamily: "'Orbitron', sans-serif",
              fontWeight: 800,
          ...
          <p style={{ color: '#A1A1AA', fontSize: 16, maxWidth: 500 }}>
            Jeder Bot ist ein eigener Worker. Lade alle ein für maximale Abdeckung auf deinem Server.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div style={{ color: '#52525B', padding: 40 }}>
            Noch keine Bots konfiguriert. Richte deine Bots in der .env Datei ein.
          </div>
        ) : (
          <div
