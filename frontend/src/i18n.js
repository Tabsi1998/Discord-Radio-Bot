...
const LOCALE_MESSAGES = {
  de: {
    ...
    bots: {
      ...
      networkSubtitle: 'Commander und Worker sind kein Gimmick, sondern ein klares Invite- und Skalierungsmodell fuer echten Betrieb.',
      networkMetrics: {
        readyBots: 'Bereit',
      ...
      proofChecks: [
        'Ein Commander bleibt der klare Einstiegspunkt fuer neue Server.',
        'Worker uebernehmen parallele Streams, statt einen einzelnen Bot zu ueberladen.',
      ...
      workerTiers: [
        { tier: 'Free', bots: 'Bot 1-2', desc: 'Genug fuer den Einstieg und die ersten parallelen Streams.' },
        { tier: 'Pro', bots: 'Bot 3-8', desc: 'Mehr Reserve fuer aktive Communitys, Events und planbare Last.' },
        { tier: 'Ultimate', bots: 'Bot 9-16', desc: 'Operator-Level fuer groessere Netzwerke, mehr Ausfallsicherheit und Power-Setups.' },
      ],
